...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gray-800 text-white p-4 sm:p-8 rounded-lg shadow-xl">
            ...
            <!-- Search Form -->
            <div class="mb-6">
                <form action="{{ route('admin.exercises.index') }}" method="GET" class="flex flex-col sm:flex-row items-center space-x-0 sm:space-x-4 w-full">
                    ...
                    <!-- Clear Search Button -->
                    @if(request('search'))
                        <a href="{{ route('admin.exercises.index') }}" class="px-4 py-2 rounded-lg btn-extra transition">
                            Clear
                        </a>
                    @endif
                </form>
