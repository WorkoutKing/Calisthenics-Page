...
@section('content')
    <div class="container mx-auto px-6 sm:px-8 py-12">
        ...
        <div class="bg-white p-8 rounded-lg shadow-xl">
            ...
            <h1 class="text-3xl font-semibold text-gray-800 mb-6">Create New Quote</h1>
            ...
            <form action="{{ route('admin.quotes.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="quote" id="quote" class="block w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" rows="4" required>{{ old('quote') }}</textarea>
                </div>

                <!-- Author Field -->
                <div class="mb-6">
                    <label for="author" class="block text-sm font-medium text-gray-700">Author (Optional)</label>
                    <input type="text" name="author" id="author" value="{{ old('author') }}" class="block w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
