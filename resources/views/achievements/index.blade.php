    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-8 rounded-lg shadow-md mb-8">
                <h1 class="text-3xl font-semibold text-blue-600 mb-6 text-center">Your Achievements</h1>

                @if($achievements->isEmpty())
                    <div class="text-center text-gray-500">
                        <i class="fas fa-sad-tear text-5xl mb-4"></i>
                        <p class="text-lg">You havent earned any achievements yet. Keep going!</p>
                        <a href="/challenges" class="mt-6 inline-block bg-blue-600 text-white px-6 py-2 rounded-lg shadow-md hover:bg-blue-700 transition duration-300">
                            Explore Challenges
                        </a>
                    </div>
                @else
                        ...
                        @foreach ($achievements as $achievement)
                            <div class="bg-gray-50 p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                                <div class="flex items-center mb-4">
                                    ...
                                    <div>
                                        <h2 class="text-lg font-semibold text-gray-800">{{ $achievement->element->name }}</h2>
                                        <p class="text-sm text-gray-600">Completed on {{ $achievement->completed_at->format('M d, Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <span class="text-green-600 text-sm">Achievement Unlocked</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
